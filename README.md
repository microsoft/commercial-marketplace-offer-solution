...
When using the repository, we recommend that the orginal files included remain unchanged, and that new files are created or copied. This will help reduce the likelyhood of future merge issues.
